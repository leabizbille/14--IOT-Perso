...
# 1. Environnement  ----------------------------------------------------------------
python -m venv myenv         # Creation de l'environnement
myenv\Scripts\activate       # Environnement activation

# 2. Git Ignore --------------------------------------------------------------------
.gitignore                   # Fichiers non partagés

# 3. Git ---------------------------------------------------------------------------
# Créez une nouvelle branche pour une fonctionnalité
git checkout -b feature/ajout-page-meteo   # Exemple

# Après changements, puis ajouter et commetter les modifications
git add .
git commit -m "Ajout de la page météo"

# Une fois le travail terminé, retour à la branche principale
git checkout main
...
python Meteo.py
python -m utils.ScrapingGRDF

# 7. Démarer l application------------------------------------------
